...
[`@aws-sdk/client-dynamodb-streams`](https://www.npmjs.com/package/@aws-sdk/client-dynamodb-streams/v/3.1079.0).
...
- @aws-sdk/client-dynamodb-streams v3.1079.0 - [https://cloud-sdk-builds.github.io/?sdk=client-dynamodb-streams&version=3.1079.0](https://cloud-sdk-builds.github.io/?sdk=client-dynamodb-streams&version=3.1079.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb-streams@3.1079.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CVD8+p6GfSYZarNzpZYODBskbBatEIdb+LXOzDGw+hSuVf+t4HF6kFjRN7FTQDth
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-dynamodb-streams": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb-streams@3.1079.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb-streams@3.1079.0/index.min.mjs": "sha384-CVD8+p6GfSYZarNzpZYODBskbBatEIdb+LXOzDGw+hSuVf+t4HF6kFjRN7FTQDth"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-dynamodb-streams/blob/refs/tags/3.1079.0/LICENSE
```
