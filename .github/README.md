...
[`@aws-sdk/client-dynamodb-streams`](https://www.npmjs.com/package/@aws-sdk/client-dynamodb-streams/v/3.567.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb-streams@3.567.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EB+xVLgfhoMCclHbBOESXTwrByiVogti22HLas1N3GfIXqH2r+ePUy9rzDb1vwfF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-dynamodb-streams": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb-streams@3.567.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb-streams@3.567.0/index.min.mjs": "sha384-EB+xVLgfhoMCclHbBOESXTwrByiVogti22HLas1N3GfIXqH2r+ePUy9rzDb1vwfF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-dynamodb-streams/blob/refs/tags/3.567.0/LICENSE
```
