...
[`@aws-sdk/client-dynamodb-streams`](https://www.npmjs.com/package/@aws-sdk/client-dynamodb-streams/v/3.296.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb-streams@3.296.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lruL0ami7+m6aBlkRS6lDoJhQR5Ce4DbBDXsxziVi/GVfBC1t1UopFfsGOQb4zgj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-dynamodb-streams": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb-streams@3.296.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb-streams@3.296.0/index.min.mjs": "sha384-lruL0ami7+m6aBlkRS6lDoJhQR5Ce4DbBDXsxziVi/GVfBC1t1UopFfsGOQb4zgj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-dynamodb-streams/blob/refs/tags/3.296.0/LICENSE
```
